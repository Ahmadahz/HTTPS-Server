...
public:
  server(boost::asio::io_service& io_service, unsigned short port)
    : io_service_(io_service),
      ...
      //https://github.com/VROOM-Project/vroom/issues/297
  {
    ...
    context_.use_certificate_chain_file("../tests/keys/localhost.pem");
    context_.use_private_key_file("../tests/keys/localhost-key.pem", boost::asio::ssl::context::pem);
    context_.use_tmp_dh_file("../tests/keys/dhparam4096.pem");
