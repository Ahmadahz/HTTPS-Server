...
class https_server {
public:
  https_server(boost::asio::io_service& io_service, short port, const NginxConfig &config);
  ...
  https_server(https_session& new_session, boost::asio::io_service& io_service, short port, const NginxConfig &config);
...
private:
  ...
  void start_accept(https_session* new_session);
